\documentclass[12pt,letterpaper,titlepage,onecolumn,twoside,openright]{book}
...
%\include{chapters/list-of-symbols}
\input{chapters/list-of-symbols}
...
\include{chapters/complex_chapter}
\include{chapters/ch-appendices}
